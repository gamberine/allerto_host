...
const NotificationSettings = ({ isOpen, onClose }) => {
  ...
  const handleSave = () => {
    localStorage.setItem('allerto_notification_settings', JSON.stringify(settings));
    toast({
          ...
          >
            <div className="glass-effect rounded-2xl p-6 border border-white/20">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold gradient-text">Configurações de Notificação</h2>
                <Button
                  variant="ghost"
                  size="icon"
                  onClick={onClose}
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <Label htmlFor={channel.id} className="text-blue-200 cursor-pointer">
                          {channel.label}
                        </Label>
                      </div>
                      <Checkbox
